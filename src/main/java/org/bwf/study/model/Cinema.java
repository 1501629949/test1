...
public class Cinema {
    ...
    private List<CinemaSpecial> specials;

    private List<CinemaService> services;
    ...
    public List<CinemaSpecial> getSpecials() {
        return specials;
    }

    public void setSpecials(List<CinemaSpecial> specials) {
        this.specials = specials;
    }

    public List<CinemaService> getServices() {
        return services;
    }

    public void setServices(List<CinemaService> services) {
