...
public class Orders {
    ...
    public Byte getOrderUserShow() {
        return orderUserShow;
    }

    public void setOrderUserShow(Byte orderUserShow) {
        this.orderUserShow = orderUserShow;
    }
